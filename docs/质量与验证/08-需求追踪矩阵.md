...
| FR-11 验证证据 | `run_command`、output panel、`14-真实模型验证.md` | exit code、stdout/stderr | 真实模型首测 2/6、二测 6/6、外部复核 6/6 |
...
| NFR-08 可测试 | 核心模块与 Preload/主进程 IPC/配置/工作区状态/快速打开/草稿/富文本/路径脱敏边界可隔离验证 | 当前 132 项自动化测试 |
...
| 验证 | 候选构建 | 132 项测试、Windows 自动化门禁、真实模型、桌面检查、交付脚本 | 无阻塞缺陷、演示稳定 | 进行中 |
